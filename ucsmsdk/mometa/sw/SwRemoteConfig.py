...
class SwRemoteConfigConsts:
    IS_FWD_DROPS_RX_FALSE = "false"
    IS_FWD_DROPS_RX_NO = "no"
    IS_FWD_DROPS_RX_TRUE = "true"
    IS_FWD_DROPS_RX_YES = "yes"
    IS_MTU_FALSE = "false"
    IS_MTU_NO = "no"
    IS_MTU_TRUE = "true"
    IS_MTU_YES = "yes"
...
class SwRemoteConfig(ManagedObject):
    ...
    mo_meta = MoMeta("SwRemoteConfig", "swRemoteConfig", "remote", VersionMeta.Version434a, "InputOutput", 0xffff, [], ["admin", "ext-lan-config", "ext-lan-policy"], ['swEthMon', 'swFcMon'], [], [None])
    ...
    prop_meta = {
        ...
        "is_fwd_drops_rx": MoPropertyMeta("is_fwd_drops_rx", "isFwdDropsRx", "string", VersionMeta.Version434a, MoPropertyMeta.READ_WRITE, 0x100, None, None, None, ["false", "no", "true", "yes"], []),
        "is_mtu": MoPropertyMeta("is_mtu", "isMtu", "string", VersionMeta.Version434a, MoPropertyMeta.READ_WRITE, 0x200, None, None, None, ["false", "no", "true", "yes"], []),
        ...
        "mtu": MoPropertyMeta("mtu", "mtu", "ushort", VersionMeta.Version434a, MoPropertyMeta.READ_WRITE, 0x400, None, None, None, [], ["64-1518"]),
        "name": MoPropertyMeta("name", "name", "string", VersionMeta.Version434a, MoPropertyMeta.READ_WRITE, 0x800, None, None, r"""[\-\.:_a-zA-Z0-9]{0,16}""", [], []),
        "rn": MoPropertyMeta("rn", "rn", "string", VersionMeta.Version434a, MoPropertyMeta.READ_ONLY, 0x1000, 0, 256, None, [], []),
        ...
        "source_ip": MoPropertyMeta("source_ip", "sourceIP", "string", VersionMeta.Version434a, MoPropertyMeta.READ_WRITE, 0x2000, 0, 256, r"""((([0-9]){1,3}\.){3}[0-9]{1,3})""", [], []),
        "source_i_pv6": MoPropertyMeta("source_i_pv6", "sourceIPv6", "string", VersionMeta.Version434a, MoPropertyMeta.READ_WRITE, 0x4000, 0, 256, None, [], []),
        "status": MoPropertyMeta("status", "status", "string", VersionMeta.Version434a, MoPropertyMeta.READ_WRITE, 0x8000, None, None, r"""((removed|created|modified|deleted),){0,3}(removed|created|modified|deleted){0,1}""", [], []),
    }
