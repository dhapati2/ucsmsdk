...
class FabricRemoteConfig(ManagedObject):
    ...
    mo_meta = MoMeta("FabricRemoteConfig", "fabricRemoteConfig", "remote", VersionMeta.Version434a, "InputOutput", 0x1fff, [], ["admin", "ext-lan-config", "ext-lan-policy"], ['fabricEthMon', 'fabricFcMon'], [], [None])
    ...
    prop_meta = {
        ...
        "is_fwd_drops_rx": MoPropertyMeta("is_fwd_drops_rx", "isFwdDropsRx", "string", VersionMeta.Version434a, MoPropertyMeta.READ_WRITE, 0x80, None, None, None, ["false", "no", "true", "yes"], []),
        ...
        "status": MoPropertyMeta("status", "status", "string", VersionMeta.Version434a, MoPropertyMeta.READ_WRITE, 0x1000, None, None, r"""((removed|created|modified|deleted),){0,3}(removed|created|modified|deleted){0,1}""", [], []),
    }
