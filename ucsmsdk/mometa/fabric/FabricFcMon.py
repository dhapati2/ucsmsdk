...
class FabricFcMonConsts:
    ...
    OPER_STATE_REASON_NO_VALID_GLOBAL_IP = "No_Valid_Global_IP"
...
class FabricFcMon(ManagedObject):
    ...
    prop_meta = {
        ...
        "oper_state_reason": MoPropertyMeta("oper_state_reason", "operStateReason", "string", VersionMeta.Version141i, MoPropertyMeta.READ_ONLY, None, None, None, None, ["ARP_Not_Resolved", "Active", "Egress_If_Not_Resolved", "Generic_Error", "Multi_Destination_Not_Allowed", "No_Destination_Configured", "No_Erspan_Id", "No_Hardware_Resource", "No_Operational_Src_Dst", "No_Route_To_Dest_IP", "No_Source_Destination_Configured", "No_Sources_Configured", "No_Valid_Global_IP", "No_Valid_IP_Address", "No_Valid_VRF", "SVI_Not_Retrived", "Session_Admin_Shut", "Unknown", "Wrong_Destination_Mode", "Wrong_Source_Mode"], []),
