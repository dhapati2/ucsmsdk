...
class NamingPropertyId:
    ...
    DS_ADMIN_ACTION = "dsAdminAction"
    DS_COMPLETION = "dsCompletion"
    DS_DECOM_SERVER = "dsDecomServer"
    DS_END_TIME = "dsEndTime"
    DS_FAILED_COMPS = "dsFailedComps"
    DS_SANITIZED_COMPS = "dsSanitizedComps"
    DS_START_TIME = "dsStartTime"
    DS_STATUS = "dsStatus"
    DS_TYPE = "dsType"
    DSCP = "dscp"
    DST_DN = "dstDn"
    ...
    PRIORITY = "priority"
    PRIORITY0 = "priority0"
    PRIORITY0_DELTA = "priority0Delta"
    PRIORITY0_DELTA_AVG = "priority0DeltaAvg"
    PRIORITY0_DELTA_MAX = "priority0DeltaMax"
    PRIORITY0_DELTA_MIN = "priority0DeltaMin"
    PRIORITY1 = "priority1"
    PRIORITY1_DELTA = "priority1Delta"
    PRIORITY1_DELTA_AVG = "priority1DeltaAvg"
    PRIORITY1_DELTA_MAX = "priority1DeltaMax"
    PRIORITY1_DELTA_MIN = "priority1DeltaMin"
    PRIORITY2 = "priority2"
    PRIORITY2_DELTA = "priority2Delta"
    PRIORITY2_DELTA_AVG = "priority2DeltaAvg"
    PRIORITY2_DELTA_MAX = "priority2DeltaMax"
    PRIORITY2_DELTA_MIN = "priority2DeltaMin"
    PRIORITY3 = "priority3"
    PRIORITY3_DELTA = "priority3Delta"
    PRIORITY3_DELTA_AVG = "priority3DeltaAvg"
    PRIORITY3_DELTA_MAX = "priority3DeltaMax"
    PRIORITY3_DELTA_MIN = "priority3DeltaMin"
    PRIORITY4 = "priority4"
    PRIORITY4_DELTA = "priority4Delta"
    PRIORITY4_DELTA_AVG = "priority4DeltaAvg"
    PRIORITY4_DELTA_MAX = "priority4DeltaMax"
    PRIORITY4_DELTA_MIN = "priority4DeltaMin"
    PRIORITY5 = "priority5"
    PRIORITY5_DELTA = "priority5Delta"
    PRIORITY5_DELTA_AVG = "priority5DeltaAvg"
    PRIORITY5_DELTA_MAX = "priority5DeltaMax"
    PRIORITY5_DELTA_MIN = "priority5DeltaMin"
    PRIORITY6 = "priority6"
    PRIORITY6_DELTA = "priority6Delta"
    PRIORITY6_DELTA_AVG = "priority6DeltaAvg"
    PRIORITY6_DELTA_MAX = "priority6DeltaMax"
    PRIORITY6_DELTA_MIN = "priority6DeltaMin"
    PRIORITY7 = "priority7"
    PRIORITY7_DELTA = "priority7Delta"
    PRIORITY7_DELTA_AVG = "priority7DeltaAvg"
    PRIORITY7_DELTA_MAX = "priority7DeltaMax"
    PRIORITY7_DELTA_MIN = "priority7DeltaMin"
