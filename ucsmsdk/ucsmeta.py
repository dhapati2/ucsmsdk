...
MO_CLASS_META = {
    ...
    "ComputeSanitizeComponent": MoMeta("ComputeSanitizeComponent", "computeSanitizeComponent", "ds-comp-[ds_type]", VersionMeta.Version434a, "InputOutput", 0x1, [], ["admin"], ['computeDataSanitize'], [], [None]),
